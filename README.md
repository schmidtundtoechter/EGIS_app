...
There is a button in the top right corner of SALES ORDER. Clicking on this button will pull the retail prices of this SALES ORDER again.
...
When you push the button, the system takes time to update the prices. You will get an info box, how many prices still have to be updated while you are waiting.  
...
Tests are conducted in December 2025/ January 2026. (EBC has no real version numbers.)
